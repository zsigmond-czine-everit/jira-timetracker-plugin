...
/**
 * Export table report event.
 */
public class ExportTableReportEvent implements AnalyticsEvent {

  private static final String ACTION_URL =
      "http://customer.jira.com/secure/ReportingWebAction!default.jspa";

  private static final String EVENT_ACTION = "Export Table Details";

  private static final String EVENT_CATEGORY = "Reporting";

  private static final String EVENT_NAME = "TableReportExport";

  private final String hashUserId;

  private String pluginId;

  public ExportTableReportEvent(final String pluginId) {
